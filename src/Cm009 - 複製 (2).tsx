...
form.setFieldsValue({ remark: `According to Regulations 11 12 of the Import and Export			
...
return (
  ...
  <div style={{ padding: '0 24px' }}>
    <Title level={4}>Function ID</Title>
     <Select
    defaultValue="Cm009"
    style={{ }}
...
<Row gutter={16}>
<Col span={12}><Flex gap="small" justify='flex-start'><Button color="primary" variant="outlined">Cancel</Button></Flex></Col>
