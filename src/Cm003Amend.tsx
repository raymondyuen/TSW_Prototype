        ...
        <>
            ...
            >
                ...
                <Row gutter={[16, 16]}>
                    ...
                    <Col span={12}>
                        <Form.Item label="Estimated Date and time of Arrival / Departure">
                    ...
                    <Col span={12}>
                        <Form.Item label="Actual Date and Time of Arrival / Departure ">
                            <Space direction="vertical">
                                <DatePicker onChange={onChangeDate} />
                                <TimePicker onChange={onChangeTime} defaultOpenValue={dayjs('00:00:00', 'HH:mm:ss')} />
                            </Space>
                    ...
                    <Col span={12}>
                        <Form.Item label="Scheduled Date and Time of Arrival / Departure">
                            <Space direction="vertical">
                                <DatePicker onChange={onChangeDate} />
                                <TimePicker onChange={onChangeTime} defaultOpenValue={dayjs('00:00:00', 'HH:mm:ss')} />
                            </Space>
